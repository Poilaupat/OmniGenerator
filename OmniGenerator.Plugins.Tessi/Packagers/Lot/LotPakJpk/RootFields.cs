...
namespace OmniGenerator.Plugins.Tessi.Packagers.Lot.LotPakJpk
{
    ...
    public class RootFields : FieldExtractorBase
    {
        ...
        public virtual string PacketName => GetOptionalStringOrDefault("packet-name", "DefaultName");
        ...
        public virtual string PacketNumber => GetOptionalStringOrDefault("packet-number", "0001");
        ...
        public virtual string MachineSerialNumber => GetOptionalStringOrDefault("scanner-serial-number", "123456789");
        ...
        public virtual DateTime PacketDate
        {
            get
            {
                var fieldValue = GetOptionalValue("packet-date");
                if (fieldValue.HasValue && fieldValue.Value.TryConvert<DateTime>(out var dateValue))
                    return dateValue;
                return DateTime.Now;
            }
        }
        ...
        public virtual string CapturePointCode => GetRequiredString("capture-point-code");
        ...
        public virtual string ScannerCode => GetOptionalStringOrDefault("scanner-code", "001");
        ...
        public virtual string OrganizationUnitCode => GetRequiredString("organization-unit-code");
        ...
        public virtual string OrganizationCode => GetRequiredString("organization-code");
        ...
        public virtual string ProcessCode => GetOptionalStringOrDefault("process-code", "000");
        ...
        public virtual string Reconciliation => GetOptionalStringOrDefault("reconciliation", "0");
    }
}
